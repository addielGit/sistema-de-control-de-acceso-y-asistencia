...
const NAV = [
  ...
  { href: '/dashboard/notifications',label: 'Notificaciones',icon: Bell,            admin: false },
      ...
      */}
      <aside
        style={{
          ...
          // Width controlled via inline style so it always overrides any CSS conflict
          width: sidebarOpen ? '256px' : '64px',
          // Transform: mobile hide/show, desktop always visible
          transform: sidebarOpen ? 'translateX(0)' : undefined,
        }}
        className={cn(
          'flex flex-col bg-gray-900 border-r border-gray-800 h-screen z-40 shrink-0',
          // Mobile: fixed overlay (out of flex flow)
          'fixed top-0 left-0',
          // Desktop: in flex flow so it pushes content
          'lg:relative lg:z-auto',
          // Mobile only: hide when closed

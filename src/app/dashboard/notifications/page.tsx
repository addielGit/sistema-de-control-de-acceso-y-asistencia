    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="glass rounded-2xl p-4 flex flex-wrap gap-3 items-center">
        ...
        >
          {FILTER_OPTS.map((o) => (
            <button
              ...
              style={{
                backgroundColor:
                  filter === o.value ? "var(--accent)" : "transparent",
        ...
        <div className="flex gap-1 flex-wrap">
          {(["ALL", "INFO", "WARNING", "SUCCESS", "ERROR"] as const).map(
            (t) => {
      ...
      {!isAdmin && (
        <p
          ...
          style={{ color: "var(--text-muted)" }}
        >
          Puedes marcar notificaciones como leídas. Solo los administradores
          pueden eliminarlas.
        </p>
      )}
    </div>
